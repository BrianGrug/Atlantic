...
public class FactionAnnouncementArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        playerFaction.broadcast(ChatColor.AQUA + player.getName() + " has updated the factions' announcement from " + ChatColor.YELLOW + (oldAnnouncement != null ? oldAnnouncement : "none")
