...
public class FactionHomeArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) throws IOException {
        ...
        /*
         * if (factionAt != playerFaction && factionAt instanceof PlayerFaction) { player.sendMessage(ChatColor.RED + "You may not warp in enemy claims. Use " + ChatColor.YELLOW + '/' + label +
         * " stuck" + ChatColor.RED + " if trapped."); return true; }
         */
        ...
        plugin.getManagerHandler().getTimerManager()
                ...
                .teleport(
                        ...
                        home,
                        millis,
                        ChatColor.AQUA + "Teleporting to your faction home in " + ChatColor.LIGHT_PURPLE + DurationFormatter.getRemaining(millis, true, false) + ChatColor.AQUA
