...
public class FactionClaimArgument extends CommandArgument {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.YELLOW + "Claiming wand added to inventory, read the item to understand how to claim. " + ChatColor.BOLD + "Alternatively" + ChatColor.YELLOW + " you can use "
                + ChatColor.AQUA + ChatColor.BOLD + '/' + label + " claimchunk" + ChatColor.YELLOW + '.');
