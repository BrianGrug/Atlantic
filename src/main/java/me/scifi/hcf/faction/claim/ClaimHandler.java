...
public class ClaimHandler {
     ...
     *
     * @param claim
     *            the {@link Cuboid} to calculate
     * @param currentClaims
     *            the current amount of claims the object being looked up has
     * @param selling
     *            if the {@link Faction} is selling the claim
     ...
     *
     * @param player
     *            the {@link Player} that is attempting to create the {@link Subclaim}
     * @param subclaim
     *            the {@link Subclaim} to be created
