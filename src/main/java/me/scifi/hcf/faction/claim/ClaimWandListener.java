    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        if (action == Action.LEFT_CLICK_BLOCK || action == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (plugin.getClaimHandler().canClaimHere(player, blockLocation)) {
                ...
                player.sendMessage(ChatColor.GREEN + "Set the location of claim selection " + ChatColor.YELLOW + selectionId + ChatColor.GREEN + " to: " + ChatColor.GOLD + '(' + ChatColor.YELLOW
                ...
                if (claimSelection.hasBothPositionsSet()) {
                    ...
                    player.sendMessage(ChatColor.AQUA + "Claim selection cost: " + (selectionPrice > playerFaction.getBalance() ? ChatColor.RED : ChatColor.GREEN) + EconomyManager.ECONOMY_SYMBOL
                            + selectionPrice + ChatColor.AQUA + ". Current size: (" + ChatColor.WHITE + claim.getWidth() + ", " + claim.getLength() + ChatColor.AQUA + "), " + ChatColor.WHITE
                            + claim.getArea() + ChatColor.AQUA + " blocks.");
                }
