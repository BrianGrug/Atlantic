...
public class Crowbar {
     ...
     *
     * @param spawnerUses
     *            the amount of Spawner uses to create with
     * @param endFrameUses
     *            the amount of End Frame uses to create with
     */
     ...
     */
    public static java.util.Optional<Crowbar> fromStack(ItemStack stack) {
        ...
        return java.util.Optional.of(crowbar);
    }
